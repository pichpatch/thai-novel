...
`.Codex/skills/json-transform/SKILL.md` is a project-local Codex skill with two modes:
...
5. **`.Codex/skills/json-transform/SKILL.md`** — the authoring skill (read before helping with episode JSON)
